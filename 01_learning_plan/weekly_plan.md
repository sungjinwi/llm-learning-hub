...
| TBD | 4 | API와 LLM 호출: 환경변수, request/response, OpenAI API 기본 구조 | not_started |
| TBD | 5 | Prompt와 구조화 출력: system/user 메시지, JSON output, prompt versioning | not_started |
| TBD | 6 | Embedding과 RAG: chunking, embedding, vector search, retrieval 확인 | not_started |
| TBD | 7 | 미니 LLM 프로젝트: FAQ 기반 QA, 로그, 간단 평가표 | not_started |
