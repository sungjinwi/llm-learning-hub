...
권장 로컬 폴더명은 `D:\llm-learning-hub`이다.
...
- `01_learning_plan/cross_repo_learning_flow.md`: `D:\llm-interaction-engineering` 연결 규칙
...
- `04_ai_prompts/prompt_quality_patterns.md`: 고품질 prompt 패턴과 구조화 규칙
- `04_ai_prompts/commit_message_guidelines.md`: 커밋 메시지 작성 규칙
- `02_methods/practice_loop.md`: 이론을 코드 실습으로 연결하는 공통 루프
- `06_tracking/study_log.md`: 학습 기록
- `06_tracking/learning_record_system.md`: 나중에 보기 좋고 문서화하기 쉬운 기록 체계
- `05_outputs/documentation_guide.md`: NotebookLM, 슬라이드, 블로그, 포트폴리오 문서화 가이드
